...
function buildMenuItems(role: UserRole | null, projectId: string | null): MenuItem[] {
  const items: AppMenuItem[] = [
    ...
    { menuKey: 'procurement', key: projectId ? `/projects/${projectId}/procurement` : '/projects/procurement', icon: <ShoppingOutlined />, href: projectId ? `/projects/${projectId}/procurement` : '/dashboard', label: 'จัดซื้อจัดจ้าง (Procurement)' },
    { menuKey: 'handover', key: projectId ? `/projects/${projectId}/handover` : '/projects/handover', icon: <InboxOutlined />, href: projectId ? `/projects/${projectId}/handover` : '/dashboard', label: 'การส่งมอบงาน (Handover)' },
    { menuKey: 'permits', key: projectId ? `/projects/${projectId}/permits` : '/projects/permits', icon: <AuditOutlined />, href: projectId ? `/projects/${projectId}/permits` : '/dashboard', label: 'ใบอนุญาตและที่ดิน (Permits & Land)' },
